...
# documentclass 需设置 AutoFakeBold， jluthesis2023 需设置 manualSpine， 需重置CJKmainfont
sed 's/\documentclass\[.*\]/\documentclass\[oneside,a4paper,12pt,AutoFakeBold\]/' example.tex | \
sed 's/^\\usepackage\[.*\]{jluthesis2023}/\\usepackage\[amd,ebook,manualSpine\]{jluthesis2023}/' | \
...
sed 's/^\\usepackage\[.*\]{jluthesis2023}/\\usepackage\[amd,ebook\]{jluthesis2023}/'|\
sed 's/\\jluCDegree{.*} /\\jluCDegree{工学硕士}/' |\
sed 's/\\jluCSubject{.*} /\\jluCSubject{计算机应用技术}/' |\
sed 's/\\jluCSubjectScd{.*} /\\jluCSubjectScd{计算机应用技术}/' |\
sed 's/\\jluCSubjectTrd{.*} /\\jluCSubjectTrd{计算机应用技术}/' |\
...
sed 's/^\\usepackage\[.*\]{jluthesis2023}/\\usepackage\[phdfancy,ebook,twoSideCover\]{jluthesis2023}/' |\
...
sed 's/\documentclass\[.*\]/\documentclass\[twoside,a4paper,12pt\]/' example.tex | \
sed 's/^\\usepackage\[.*\]{jluthesis2023}/\\usepackage\[phdplain,hardcopy\]{jluthesis2023}/' |\
sed 's/\\jluCDegree{.*} /\\jluCDegree{工学博士}/' |\
sed 's/\\jluCSubject{.*} /\\jluCSubject{计算机应用技术}/' |\
sed 's/\\jluCSubjectScd{.*} /\\jluCSubjectScd{计算机应用技术}/' |\
sed 's/\\jluCSubjectTrd{.*} /\\jluCSubjectTrd{计算机应用技术}/' |\
...
sed 's/\documentclass\[.*\]/\documentclass\[twoside,a4paper,12pt\]/' example.tex | \
sed 's/^\\usepackage\[.*\]{jluthesis2023}/\\usepackage\[phdplain,hardcopy,twoSideCover,onlyCover\]{jluthesis2023}/' |\
sed 's/\\jluCDegree{.*} /\\jluCDegree{工学博士}/' |\
sed 's/\\jluCSubject{.*} /\\jluCSubject{计算机应用技术}/' |\
sed 's/\\jluCSubjectScd{.*} /\\jluCSubjectScd{计算机应用技术}/' |\
sed 's/\\jluCSubjectTrd{.*} /\\jluCSubjectTrd{计算机应用技术}/' |\
...
sed 's/\documentclass\[.*\]/\documentclass\[oneside,a4paper,12pt\]/' example.tex | \
sed 's/^\\usepackage\[.*\]{jluthesis2023}/\\usepackage\[pmd,hardcopy,onlyCover\]{jluthesis2023}/' |\
...
sed 's/\documentclass\[.*\]/\documentclass\[twoside,a4paper,12pt\]/' example.tex | \
sed 's/^\\usepackage\[.*\]{jluthesis2023}/\\usepackage\[pmd,hardcopy\]{jluthesis2023}/'|\
sed 's/\\jluCDegree{.*} /\\jluCDegree{工程硕士}/' |\
sed 's/\\jluCSubject{.*} /\\jluCSubject{工程硕士}/' |\
sed 's/\\jluCSubjectScd{.*} /\\jluCSubjectScd{计算机技术}/' |\
sed 's/\\jluCSubjectTrd{.*} /\\jluCSubjectTrd{计算机技术}/' |\
...
sed 's/\documentclass\[.*\]/\documentclass\[twoside,a4paper,12pt\]/' example.tex | \
sed 's/^\\usepackage\[.*\]{jluthesis2023}/\\usepackage\[pmd,hardcopy,noBlankPages\]{jluthesis2023}/'|\
sed 's/\\jluCDegree{.*} /\\jluCDegree{工程硕士}/' |\
sed 's/\\jluCSubject{.*} /\\jluCSubject{工程硕士}/' |\
sed 's/\\jluCSubjectScd{.*} /\\jluCSubjectScd{计算机技术}/' |\
sed 's/\\jluCSubjectTrd{.*} /\\jluCSubjectTrd{计算机技术}/' |\
...
sed 's/\documentclass\[.*\]/\documentclass\[oneside,a4paper,12pt\]/' example.tex | \
sed 's/^\\usepackage\[.*\]{jluthesis2023}/\\usepackage\[amd,hardcopy\]{jluthesis2023}/'|\
sed 's/\\jluCDegree{.*} /\\jluCDegree{工学硕士}/' |\
sed 's/\\jluCSubject{.*} /\\jluCSubject{计算机应用技术}/' |\
sed 's/\\jluCSubjectScd{.*} /\\jluCSubjectScd{计算机应用技术}/' |\
sed 's/\\jluCSubjectTrd{.*} /\\jluCSubjectTrd{计算机应用技术}/' |\
